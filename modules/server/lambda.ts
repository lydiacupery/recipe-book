module.exports.handler = function(event: any, context: any, callback: any) {
  console.log("Received event {}", JSON.stringify(event, null, 3));
    var posts: {[k: string]: {id: string, title: string, author: string, url: string | null, content: string | null, ups: string | null, downs: string | null }} = {
    ...
    switch(event.field) {
        ...
        case "addPostErrorWithData":
            ...
            const response = {
              ...result,
              errorMessage: 'Error with the mutation, data has changed',
